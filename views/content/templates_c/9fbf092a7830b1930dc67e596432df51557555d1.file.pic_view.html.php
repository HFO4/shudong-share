<?php /* Smarty version Smarty-3.1.18, created on 2015-08-04 03:24:46
         compiled from ".\..\content\themes\def\pic_view.html" */ ?>
<?php /*%%SmartyHeaderCode:782855c0307e538825-40909814%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9fbf092a7830b1930dc67e596432df51557555d1' => 
    array (
      0 => '.\\..\\content\\themes\\def\\pic_view.html',
      1 => 1438610818,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '782855c0307e538825-40909814',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55c0307e6ca527_37574513',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55c0307e6ca527_37574513')) {function content_55c0307e6ca527_37574513($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
" id="fxurl" /> 
         <button type="button" data-clipboard-target="fxurl" id="fzfx" class="btn btn-primary"> 复制链接 </button>
        </div> 
        <br />
       </div> 
...
<div align="center">
         <button type="button" style="position:relative; top:5px;" data-clipboard-text="11" id="fzfx-lock" class="btn btn-primary"> 复制链接及密码 </button></div>
        </div> 
...
&quot;/&gt;" class="btn btn-default"><span class="glyphicon glyphicon-qrcode" aria-hidden="true"></span> 二维码</button> 
    ...
    <button data-toggle="tooltip" data-placement="top" type="button" title="查看文件大小、名称等信息" id="qr" class="btn btn-default"><span class="glyphicon glyphicon-tags
...
" /></td> 
       <td width="90"><input type="button" name="fuzhi" id="fuzhi" class="btn btn-primary" value="复制" data-clipboard-target="yuantu" /> </td> 
      </tr> 
     </tbody> 
    </table> 
   </div> 
...
&quot; alt=&quot;<?php echo $_smarty_tpl->tpl_vars['filename']->value;?>
&quot; &gt; </textarea></td> 
       <td width="106"><input type="button" name="daima1" id="daima1" class="btn btn-primary" data-clipboard-target="code1" value="复制" /></td> 
      </tr> 
     </tbody> 
    </table> 
   </div> 
