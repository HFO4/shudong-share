                    ...
                    <h1 class="page-header">分享管理</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#" data-toggle="tab">公开分享</a>
                                </li>
                                <li><a href="share_sskey.php" >私密分享</a>
                                </li>
...
$numq=mysql_query("SELECT * FROM `sd_ss`");
...
$pagenum=ceil($num/$pagesize);
 ...
 <tr>
 	<td>'.$row["id"].'</td>
		<td>'.$row["fname"].'</td>
	<td><a href="'.$kjurl.$ming.'" target="new" >'.$ming.'</a></td>
	<td>'.$row["sstime"].'</td>
	...
	<td><div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a href="../includes/admin_del_share.php?key='.$row["sskey"].'&type=ss">删除分享</a>
                                        </li>
                                        <li><a target="new" href="../f.php?k='.$row["sskey"].'">查看分享</a>
                                        </li>
