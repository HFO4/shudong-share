                    ...
                    <h1 class="page-header">文件管理</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#" data-toggle="tab">现存文件</a>
                                </li>
                                <li><a href="file_del.php" >用户删除文件</a>
                                </li>
...
$numq=mysql_query("SELECT * FROM `sd_file` WHERE cishuo='0'");
...
$line="SELECT * FROM `sd_file` WHERE cishuo='0' ORDER BY `id` DESC limit $page $pagesize";
$pagenum=ceil($num/$pagesize);
 ...
 <tr>
 	<td>'.$row["id"].'</td>
	<td><a href="'.$kjurl.$row['ming'].'" target="new" >'.$row["ming"].'</a></td>
	...
	<td><div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a href="../includes/admin_del.php?key='.$row["key1"].'&dfile=true">删除文件</a>
                                        </li>
                                        <li><a href="../includes/admin_del.php?key='.$row["key1"].'&djilu=true">删除记录</a>
                                        </li>
                                        <li><a href="../includes/admin_del.php?key='.$row["key1"].'&dfile=true&djilu=true">删除文件及记录</a>
                                        </li>
